...
### Лучшее расположение защиты по ролям защитников защитников
...
bestpos <- playerTypeTacticsGraphDraw("DB", "SHOTGUN")
bestposs <- rbind(bestposs, bestpos)
bestpos <- playerTypeTacticsGraphDraw("DB", "SINGLEBACK")
bestposs <- rbind(bestposs, bestpos)
bestpos <- playerTypeTacticsGraphDraw("DB", "I_FORM")
bestposs <- rbind(bestposs, bestpos)
bestpos <- playerTypeTacticsGraphDraw("DB", "PISTOL")
bestposs <- rbind(bestposs, bestpos)
bestpos <- playerTypeTacticsGraphDraw("DB", "EMPTY")
bestposs <- rbind(bestposs, bestpos)
bestpos <- playerTypeTacticsGraphDraw("DB", "JUMBO")
bestposs <- rbind(bestposs, bestpos)
bestpos <- playerTypeTacticsGraphDraw("DB", "WILDCAT", ck = 3)
bestposs <- rbind(bestposs, bestpos)
